...
mixin _$SplashStore on _SplashStoreBase, Store {
  ...
  late final _$dismmissAsyncAction =
      AsyncAction('_SplashStoreBase.dismmiss', context: context);

  @override
  Future<void> dismmiss() {
    return _$dismmissAsyncAction.run(() => super.dismmiss());
  }
  ...
  void wipeStore() {
    final _$actionInfo = _$_SplashStoreBaseActionController.startAction(
        name: '_SplashStoreBase.wipeStore');
    try {
